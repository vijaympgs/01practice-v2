...
const UltraPremiumItemMaster = () => {
        ...
        return (
            <Box sx={{ p: 3, textAlign: 'center' }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
                    Please log in to access Ultra Premium Item Master.
                </Typography>
                <Button
                    variant="contained"
    ...
    return (
        <Box sx={{ p: 3 }}>
            {/* Header */}
            <PageTitle
                title="Ultra Premium Item Master"
                subtitle="Enterprise-grade item management with advanced features"
            />
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="md" fullWidth>
                ...
                <DialogContent sx={{ p: 0 }}>
                    ...
                    >
                        ...
                        <Tab label="Images" icon={<CloudUploadIcon />} iconPosition="start" />
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    ...
                                    <TextField
                                        ...
                                        onChange={(e) => {
                                            setForm({ ...form, item_image: e.target.value });
...
export default UltraPremiumItemMaster;
