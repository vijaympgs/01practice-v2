...
export const getMenuCategories = (menuVisibility) => [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Layout Preferences', icon: 'ViewQuilt', path: '/settings/layout-preferences', moduleName: 'layout_preferences', parentCategory: 'admin_tools' },
      { text: 'Digital Marketing Console', icon: 'Language', path: '/settings/digital-marketing', moduleName: 'digital_marketing_console', parentCategory: 'admin_tools' },
      { text: 'Web Console', icon: 'Code', path: '/settings/web-console', moduleName: 'web_console', parentCategory: 'admin_tools' },
      { text: 'HTML Preview Tool', icon: 'Preview', path: '/settings/html-preview', moduleName: 'html_preview_tool', parentCategory: 'admin_tools' },
      { text: 'DataOps Studio', icon: 'CodeIcon', path: '/settings/dataops-studio', moduleName: 'database_client', parentCategory: 'admin_tools' },
      { text: 'Wireframe Launchpad', icon: 'Launch', path: '/wireframes', moduleName: 'wireframe_index', parentCategory: 'admin_tools' },
      { text: 'Business Rules', icon: 'Assignment', path: '/business-rules', moduleName: 'business_rules' },
