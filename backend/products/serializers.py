...
class ItemMasterSerializer(serializers.ModelSerializer):
    ...
    item_category_code = serializers.CharField(source='item_category.code', read_only=True)
    item_subcategory_name = serializers.CharField(source='item_subcategory.name', read_only=True)
    item_subcategory_code = serializers.CharField(source='item_subcategory.code', read_only=True)
    profit_margin = serializers.ReadOnlyField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'category_name', 'item_category', 'item_category_name', 'item_category_code',
            'item_subcategory', 'item_subcategory_name', 'item_subcategory_code',
        ...
        read_only_fields = ['id', 'created_at', 'updated_at', 'base_uom_code', 'purchase_uom_code', 'sales_uom_code', 'category_name', 'item_category_name', 'item_category_code', 'item_subcategory_name', 'item_subcategory_code', 'profit_margin']
...
class ItemMasterListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ItemMaster
        fields = ['id', 'item_code', 'item_name', 'brand', 'cost_price', 'sell_price', 'mrp', 'base_uom_code', 'purchase_uom_code', 'sales_uom_code', 'category_name', 'item_category', 'item_category_name', 'item_category_code', 'item_subcategory', 'item_subcategory_name', 'item_subcategory_code', 'is_active']
