...
class ItemMaster(models.Model):
    ...
    # Category
    category = models.ForeignKey('categories.ProductClassification', on_delete=models.SET_NULL, null=True, blank=True)
    ...
    item_subcategory = models.ForeignKey(
        'categories.ItemSubCategory', 
        on_delete=models.SET_NULL, 
        null=True, 
        blank=True,
        related_name='items',
        help_text="Item sub-category for detailed classification"
    )
